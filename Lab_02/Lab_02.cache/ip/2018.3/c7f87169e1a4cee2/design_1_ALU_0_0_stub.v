...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(A, B, ALUOp, SHAMT, Zero, Overflow, R)
/* synthesis syn_black_box black_box_pad_pin="A[31:0],B[31:0],ALUOp[3:0],SHAMT[4:0],Zero,Overflow,R[31:0]" */;
  input [31:0]A;
  input [31:0]B;
  input [3:0]ALUOp;
  input [4:0]SHAMT;
